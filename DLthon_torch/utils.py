...
from metrics import precision, recall, F2, dice_score, jac_score, calculate_iou
...
def calculate_metrics(y_true, y_pred):
    ...
    score_iou = calculate_iou(y_true, y_pred)

    return [score_jaccard, score_f1, score_recall, score_precision, score_acc, score_fbeta, score_iou]